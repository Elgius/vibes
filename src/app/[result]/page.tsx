...
const analysisData = {
  ...
  romantic: {
    title: "Your Love Story Analysis",
    description: "Here's the story of your connection 💕",
    cards: [
      {
        title: "Your Current Situation",
        content:
  ...
  sunny: {
    title: "Your Relationship Analysis",
    description: "Here's the bright side of your situation ☀️",
    cards: [
      {
        title: "Your Current Situation",
        content:
  ...
  mystical: {
    title: "Your Connection Analysis",
    description: "Here's the deeper meaning of your connection 🌙",
    cards: [
      {
        title: "Your Current Situation",
        content:
  ...
  serene: {
    title: "Your Bond Analysis",
    description: "Here's the peaceful perspective on your situation ☁️",
    cards: [
      {
        title: "Your Current Situation",
        content:
...
export default function ResultPage() {
  ...
  const data = analysisData[currentPalette];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 mb-4">
              <span className="text-4xl">{moodIcons[currentPalette]}</span>
